    ...
    return (
        <nav className="bg-gray-800 shadow-lg">
                ...
                <span className="font-semibold text-white text-lg">Alumni Information System</span>
                    ...
                    <div className="md:hidden flex items-center">
                        <button className="outline-none mobile-menu-button" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
                            <svg className="w-6 h-6 text-gray-300 hover:text-yellow-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden`}>
                <ul>
                    <li><a href="#" className="block text-sm px-2 py-4 text-gray-700 hover:bg-yellow-500 transition duration-300">Home</a></li>
                    <li><a href="#" className="block text-sm px-2 py-4 text-gray-700 hover:bg-yellow-500 transition duration-300">Services</a></li>
                    <li><a href="#" className="block text-sm px-2 py-4 text-gray-700 hover:bg-yellow-500 transition duration-300">About</a></li>
                    <li><a href="#" className="block text-sm px-2 py-4 text-gray-700 hover:bg-yellow-500 transition duration-300">Contact Us</a></li>
                </ul>
            </div>
        </nav>
    );
