...
import { makeDonation } from '../../redux/store/donationSlice'; // Correct path according to your structure
...
const MakeDonationPage = () => {
    ...
    const { token } = useSelector(state => state.auth); // Assuming auth slice exists and contains the token
    ...
    const openRazorpayCheckout = async (data) => {
        ...
        const options = {
            key: 'rzp_test_4eiyhDHBG1welP', // Replace with your actual API key
